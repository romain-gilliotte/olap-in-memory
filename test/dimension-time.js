...
const { TimeDimension } = require('../dist');
...
describe('TimeDimension', function () {
    ...
    it('should give proper attributes', function () {
        ...
        assert.sameMembers(dimension.attributes, ['month', 'quarter', 'semester', 'year', 'all']);
    });
    ...
    it('should be able to humanize labels after dice', function () {
        ...
        assert.deepEqual(newDimension.getEntries('quarter', 'fr'), [['2010-Q1', '1er trim. 2010']]);
    });
});
